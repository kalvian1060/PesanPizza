...
public class LoginActivity  extends Activity {
    ...
    JSONArray pemesan;
    int success=0;
    private static final String LOGIN_URL = "http://trackingpizza.pe.hu/trackingPizza/loginpemesan.php";
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";
    private static final String TAG_NAMA = "username_pemesan";
    private static final String TAG_PASSWORD = "password_pemesan";
...
//        });
    ...
    class Login extends AsyncTask<String , String , Integer>{
        ...
        protected Integer doInBackground(String... params) {
            ...
            String username_pemesan = params[0];
            String password_pemesan = params[1];
            param.add(new BasicNameValuePair(TAG_NAMA,username_pemesan));
            param.add(new BasicNameValuePair(TAG_PASSWORD,password_pemesan));

            json = jsonParser.makeHttpRequest(LOGIN_URL,"GET",param);
            Log.d(" ", "json: " +json);
            try{
                success = json.getInt(TAG_SUCCESS);
                pemesan = json.getJSONArray("pemesan");
                if(success == 1){
        ...
        protected void onPostExecute(Integer s) {
            pDialog.dismiss();
            if(s == 1){
                Intent home = new Intent(getApplicationContext(),TambahPemesan.class);
