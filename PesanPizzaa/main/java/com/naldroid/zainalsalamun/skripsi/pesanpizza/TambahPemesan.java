...
public class TambahPemesan extends Activity {
    ...
    private static String url_tambah_pemesan = "http://trackingpizza.pe.hu/trackingPizza/tambahpemesan.php";
    ...
    class BuatAnggotaBaru extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TambahPemesan.this);
        ...
        protected String doInBackground(String... args) {
            ...
            //r mengambil JSON Object dengan method POST
            JSONObject json = jsonParser.makeHttpRequest(url_tambah_pemesan,
                    "POST", params);
